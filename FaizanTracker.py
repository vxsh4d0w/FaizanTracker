...
stderr.writelines(f"""{Gr}
          ...
          {Wh}[ + ]  C O D E   B Y  F A I Z A N  [ + ]  
        
    {Wh}[ 1 ] {Gr}IP Tracker F A I Z A N 
    {Wh}[ 2 ] {Gr}Show Your IP F A I Z A N 
    {Wh}[ 3 ] {Gr}Phone Tracker F A I Z A N
    {Wh}[ 4 ] {Gr}Username Tracker F A I Z A N
    {Wh}[ 0 ] {Gr}Exit F A I Z A N 
""")

input_user = input(f'\n   {Wh}@JERRY~# {Gr}') #OPSI MENU
...
if input_user == '1': #OPSI 1
    ...
    stderr.writelines(f"""{Wh}
     .-.
   .'   `.          {Wh}--------------------------------
   :g g   :         {Wh}| {Gr}FAIZAN- TRACKER - IP ADDRESS {Wh}|
   : o    `.        {Wh}|     {Gr}CODE BY F A I Z A N        {Wh}|
  :         ``.     {Wh}--------------------------------
 :             `.
:  :         .   `.
:   :          ` . `.
 `.. :            `. ``;
    ...
    stderr.writelines(f"""{Wh}
     .-.
   .'   `.          {Wh}----------------------------------
   :g g   :         {Wh}| {Gr}FAIZAN - TRACKER - PHONE NUMBER {Wh}|
   : o    `.        {Wh}|        {Gr}@CODE BY F A I Z A N      {Wh}|
  :         ``.     {Wh}----------------------------------
 :             `.
:  :         .   `.
:   :          ` . `.
 `.. :            `. ``;
    ...
    stderr.writelines(f"""{Wh}
     .-.
   .'   `.          {Wh}----------------------------------
   :g g   :         {Wh}|  {Gr}FAIZAN - SHOW YOUR IP ADDRESS  {Wh}|
   : o    `.        {Wh}|        {Gr}@CODE BY F A I Z A N       {Wh}|
  :         ``.     {Wh}----------------------------------
 :             `.
:  :         .   `.
...
""")
    ...
    stderr.writelines(f"""{Wh}
     .-.
   .'   `.          {Wh}----------------------------------
   :g g   :         {Wh}|    {Gr}FAIZAN - TRACKER USERNAME    {Wh}|
   : o    `.        {Wh}|        {Gr}@CODE BY F A I Z A N       {Wh}|
  :         ``.     {Wh}----------------------------------
 :             `.
:  :         .   `.
...
""")
    try:
        def TrackLu(username):
            ...
            {"url": "https://www.x.com/{}", "name": "Twitter"},
    ...
    print(f"\n  {Wh}[{Ye}!{Wh}] {Ye}THANK'S FOR USING TOOL {Ye}FAIZAN-TRACK !")
else:
